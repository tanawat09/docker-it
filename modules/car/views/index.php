...
class View extends \Car\Tools\View
{
    ...
    public function render(Request $request, $params)
    {
        ...
        $this->vehicles = \Car\Vehicles\Model::toSelect();
        ...
        $table = new DataTable(array(
            ...
            'hideColumns' => array('today', 'color', 'end', 'begin'),
    ...
    public function onRow($item, $o, $prop)
    {
        ...
        $item['detail'] = '<span class=two_lines>'.$item['detail'].'</span>';
    ...
    public function onCreateButton($btn, $attributes, $item)
    {
        if ($btn == 'edit') {
            ...
            return \Car\Index\Model::canCancle($item['today'], $item['status']) ? $attributes : false;
        } elseif ($btn == 'delete') {
