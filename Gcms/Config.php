...
class Config extends \Kotchasan\Config
{
     ...
     * @var array
     */
    public $categories_required = array('department');
    /**
     * รายการหมวดหมู่ที่สมาชิกไม่สามารถแก้ไขได้
     *
     * @var array
     */
    public $categories_disabled = array('department');
    /**
     ...
     * @var array
     */
    public $car_img_typies = array('jpg', 'jpeg', 'png');
    /**
     * สถานะอนุมัติการจองรถ
     *
     * @var int
     */
    public $car_approved_status = 1;
    /**
     * สถานะการจองที่แสดงในปฏิทิน
     *
     * @var array
     */
    public $car_calendar_status = array(1);
    /**
     * การยกเลิกการจองรถ
     *
     * @var int
